...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("EACONSULTDataSet3"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class EACONSULTDataSet3
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As EACONSULTDataSet3 = CType(MyBase.Clone,EACONSULTDataSet3)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "EACONSULTDataSet3"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/EACONSULTDataSet3.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As EACONSULTDataSet3 = New EACONSULTDataSet3()
    ...
    Partial Public Class StaffDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddStaffRow(ByVal STAFFID As String, ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal POSITION As String, ByVal CONTACT As String, ByVal LOCATION As String, ByVal SALARY As Double, ByVal PHOTO() As Byte) As StaffRow
            Dim rowStaffRow As StaffRow = CType(Me.NewRow,StaffRow)
            Dim columnValuesArray() As Object = New Object() {STAFFID, FIRSTNAME, LASTNAME, POSITION, CONTACT, LOCATION, SALARY, PHOTO}
        ...
        Private Sub InitClass()
            ...
            Me.columnLOCATION.MaxLength = 40
        End Sub
    ...
    Partial Public Class StaffRow
        ...
        Public Property SALARY() As Double
            Get
                Try 
                    Return CType(Me(Me.tableStaff.SALARYColumn),Double)
...
Namespace EACONSULTDataSet3TableAdapters
    ...
    Partial Public Class StaffTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Staff] WHERE (([STAFFID] = @Original_STAFFID) AND ([FIRSTNAME]"& _ 
                " = @Original_FIRSTNAME) AND ([LASTNAME] = @Original_LASTNAME) AND ([POSITION] = "& _ 
                "@Original_POSITION) AND ([CONTACT] = @Original_CONTACT) AND ([LOCATION] = @Origi"& _ 
                "nal_LOCATION) AND ((@IsNull_SALARY = 1 AND [SALARY] IS NULL) OR ([SALARY] = @Ori"& _ 
                "ginal_SALARY)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Staff] ([STAFFID], [FIRSTNAME], [LASTNAME], [POSITION], [CONTA"& _ 
                "CT], [LOCATION], [SALARY], [PHOTO]) VALUES (@STAFFID, @FIRSTNAME, @LASTNAME, @PO"& _ 
                "SITION, @CONTACT, @LOCATION, @SALARY, @PHOTO);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT STAFFID, FIRSTNAME, LASTN"& _ 
                "AME, POSITION, CONTACT, LOCATION, SALARY, PHOTO FROM Staff WHERE (STAFFID = @STA"& _ 
                "FFID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Staff] SET [STAFFID] = @STAFFID, [FIRSTNAME] = @FIRSTNAME, [LASTNAM"& _ 
                "E] = @LASTNAME, [POSITION] = @POSITION, [CONTACT] = @CONTACT, [LOCATION] = @LOCA"& _ 
                "TION, [SALARY] = @SALARY, [PHOTO] = @PHOTO WHERE (([STAFFID] = @Original_STAFFID"& _ 
                ") AND ([FIRSTNAME] = @Original_FIRSTNAME) AND ([LASTNAME] = @Original_LASTNAME) "& _ 
                "AND ([POSITION] = @Original_POSITION) AND ([CONTACT] = @Original_CONTACT) AND (["& _ 
                "LOCATION] = @Original_LOCATION) AND ((@IsNull_SALARY = 1 AND [SALARY] IS NULL) O"& _ 
                "R ([SALARY] = @Original_SALARY)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT STAFFID, FIRSTNAME, LASTNAME, POSITIO"& _ 
                "N, CONTACT, LOCATION, SALARY, PHOTO FROM Staff WHERE (STAFFID = @STAFFID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT STAFFID, FIRSTNAME, LASTNAME, POSITION, CONTACT, LOCATION, SALARY, PHOTO F"& _ 
                "ROM dbo.Staff"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As EACONSULTDataSet3.StaffDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As EACONSULTDataSet3.StaffDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As EACONSULTDataSet3.StaffDataTable = New EACONSULTDataSet3.StaffDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As EACONSULTDataSet3.StaffDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As EACONSULTDataSet3) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_STAFFID As String, ByVal Original_FIRSTNAME As String, ByVal Original_LASTNAME As String, ByVal Original_POSITION As String, ByVal Original_CONTACT As String, ByVal Original_LOCATION As String, ByVal Original_SALARY As Global.System.Nullable(Of Double)) As Integer
            ...
            If (Original_SALARY.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(7).Value = CType(Original_SALARY.Value,Double)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal STAFFID As String, ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal POSITION As String, ByVal CONTACT As String, ByVal LOCATION As String, ByVal SALARY As Global.System.Nullable(Of Double), ByVal PHOTO() As Byte) As Integer
            ...
            If (SALARY.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(6).Value = CType(SALARY.Value,Double)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal STAFFID As String, ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal POSITION As String, ByVal CONTACT As String, ByVal LOCATION As String, ByVal SALARY As Global.System.Nullable(Of Double), ByVal PHOTO() As Byte, ByVal Original_STAFFID As String, ByVal Original_FIRSTNAME As String, ByVal Original_LASTNAME As String, ByVal Original_POSITION As String, ByVal Original_CONTACT As String, ByVal Original_LOCATION As String, ByVal Original_SALARY As Global.System.Nullable(Of Double)) As Integer
            If (STAFFID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("STAFFID")
            Else
            ...
            End If
            If (SALARY.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(SALARY.Value,Double)
            Else
            ...
            If (Original_SALARY.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_SALARY.Value,Double)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal POSITION As String, ByVal CONTACT As String, ByVal LOCATION As String, ByVal SALARY As Global.System.Nullable(Of Double), ByVal PHOTO() As Byte, ByVal Original_STAFFID As String, ByVal Original_FIRSTNAME As String, ByVal Original_LASTNAME As String, ByVal Original_POSITION As String, ByVal Original_CONTACT As String, ByVal Original_LOCATION As String, ByVal Original_SALARY As Global.System.Nullable(Of Double)) As Integer
            Return Me.Update(Original_STAFFID, FIRSTNAME, LASTNAME, POSITION, CONTACT, LOCATION, SALARY, PHOTO, Original_STAFFID, Original_FIRSTNAME, Original_LASTNAME, Original_POSITION, Original_CONTACT, Original_LOCATION, Original_SALARY)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As EACONSULTDataSet3, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As EACONSULTDataSet3, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._staffTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As EACONSULTDataSet3, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._staffTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As EACONSULTDataSet3) As Integer
