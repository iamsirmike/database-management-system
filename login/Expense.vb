    ...
    Private Sub bnsave_Click(sender As Object, e As EventArgs) Handles bnsave.Click
        ...
        Else
            Try
                ...
                Using cmd As New SqlCommand("INSERT INTO Expense(ID, Purpose, Amount, IDescription, IDate, TOTAL) VALUES ('" & txtID.Text & "', '" & txtpurpose.Text & "', '" & txtamount.Text & "', '" & txtdescription.Text & "', '" & dtpdate.Text & "', '" & txttotal.Text & "')", con)
